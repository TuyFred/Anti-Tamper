        ...
        {activeTransit ? (
          <div className="space-y-3">
            ...
            <div className="p-3 rounded-xl bg-surface/80 border border-border space-y-2 text-sm">
              <p className="flex gap-2 text-white break-words"><MapPin className="w-4 h-4 text-success shrink-0" />{activeTransit.pickup_address}</p>
              <p className="flex gap-2 text-white break-words"><MapPin className="w-4 h-4 text-primary-light shrink-0" />{activeTransit.delivery_address}</p>
            </div>
