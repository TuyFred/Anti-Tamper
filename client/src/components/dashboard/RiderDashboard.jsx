        ...
        {nextJob ? (
          <div className="space-y-3">
            ...
            <div className="p-3 rounded-xl bg-surface/80 border border-border space-y-2 text-sm">
              <p className="text-[10px] font-bold uppercase tracking-wide text-slate-500">Route A → B</p>
              <p className="flex gap-2 text-white break-words">
                <MapPin className="w-4 h-4 text-success shrink-0" />
                <span><span className="text-success font-semibold">A</span> {nextJob.pickup_address}</span>
              </p>
              <p className="flex gap-2 text-white break-words">
                <MapPin className="w-4 h-4 text-primary-light shrink-0" />
                <span><span className="text-primary-light font-semibold">B</span> {nextJob.delivery_address}</span>
              </p>
            </div>
          </div>
        ) : (
